<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" label="排列序号" prop="sortOrder" />

      <el-table-column align="center" min-width="100" label="名称" prop="name" />

      <el-table-column align="center" min-width="100" label="商品分类" prop="categoryName" />
      ...
      <el-table-column align="center" label="是否秒杀" prop="isKill">
        <template slot-scope="scope">
          <el-tag :type="scope.row.isKill ? 'success' : 'error' ">{{ scope.row.isKill ? '秒杀' : '非秒杀' }}</el-tag>
        </template>
      </el-table-column>
...
export default {
  ...
  created() {
    ...
    listCatAndBrand().then(res => {
      ...
      this.options = [value, ...res.data.data.categoryList]
